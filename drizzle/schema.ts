...
export const boardMember = pgTable(
  ...
  (table) => [
    index('board_member_board_id_idx').using(
      'btree',
      table.boardId.asc().nullsLast().op('text_ops'),
    ),
    index('board_member_user_id_idx').using(
      'btree',
      table.userId.asc().nullsLast().op('text_ops'),
    ),
    foreignKey({
...
export const list = pgTable(
  ...
  (table) => [
    index('list_board_id_idx').using(
      'btree',
      table.boardId.asc().nullsLast().op('text_ops'),
    ),
    index('list_position_idx').using(
      'btree',
...
export const card = pgTable(
  ...
  (table) => [
    index('card_due_date_idx').using(
      'btree',
      table.dueDate.asc().nullsLast().op('timestamp_ops'),
    ),
    index('card_list_id_idx').using(
      'btree',
      table.listId.asc().nullsLast().op('text_ops'),
    ),
    index('card_position_idx').using(
      'btree',
      table.listId.asc().nullsLast().op('text_ops'),
      table.position.asc().nullsLast().op('text_ops'),
    ),
    foreignKey({
...
export const cardLabel = pgTable(
  ...
  (table) => [
    index('card_label_card_id_idx').using(
      'btree',
      table.cardId.asc().nullsLast().op('text_ops'),
    ),
    index('card_label_label_id_idx').using(
      'btree',
...
export const label = pgTable(
  ...
  (table) => [
    index('label_board_id_idx').using(
      'btree',
      table.boardId.asc().nullsLast().op('text_ops'),
    ),
    foreignKey({
...
export const board = pgTable(
  ...
  (table) => [
    index('board_access_idx').using(
      'btree',
      table.isPrivate.asc().nullsLast().op('text_ops'),
      table.ownerId.asc().nullsLast().op('enum_ops'),
    ),
    index('board_created_at_idx').using(
      'btree',
      table.createdAt.asc().nullsLast().op('timestamp_ops'),
    ),
    index('board_is_private_idx').using(
      'btree',
      table.isPrivate.asc().nullsLast().op('enum_ops'),
    ),
    index('board_owner_id_idx').using(
      'btree',
...
export const userNotificationPreferences = pgTable(
  ...
  (table) => [
    index('user_notification_preferences_user_idx').using(
      'btree',
      table.userId.asc().nullsLast().op('text_ops'),
    ),
    foreignKey({
...
export const activityLog = pgTable(
  ...
  (table) => [
    index('activity_board_created_idx').using(
      'btree',
      table.boardId.asc().nullsLast().op('timestamp_ops'),
      table.createdAt.asc().nullsLast().op('text_ops'),
    ),
    index('activity_created_idx').using(
      'btree',
      table.createdAt.asc().nullsLast().op('timestamp_ops'),
    ),
    index('activity_entity_idx').using(
      'btree',
      table.entityType.asc().nullsLast().op('text_ops'),
      table.entityId.asc().nullsLast().op('text_ops'),
    ),
    index('activity_user_created_idx').using(
      'btree',
...
export const notification = pgTable(
  ...
  (table) => [
    index('notification_created_idx').using(
      'btree',
      table.createdAt.asc().nullsLast().op('timestamp_ops'),
    ),
    index('notification_user_unread_idx').using(
      'btree',
      table.userId.asc().nullsLast().op('text_ops'),
